...
over.goseq <- function(de.contigs, contigs, map){
  ...
  names(de) <- contigs
  bias.data <- as.integer(contig.df[contig.df$contig%in%rownames(counts.frame),
                                    "length"])
...
GO.over.sex <- over.goseq(contigs.l[[1]],
                          ...
                          ann.mapping)
GO.over.sex.all <- over.goseq(contigs.l[[1]],
                              rownames(counts.frame),
                              all.ann.mapping)
...
GO.over.eel <- over.goseq(contigs.l[[2]],
                          rownames(counts.frame),
                          ann.mapping)
GO.over.eel.all <- over.goseq(contigs.l[[2]],
                              rownames(counts.frame),
                              all.ann.mapping)
...
GO.over.pop <- over.goseq(contigs.l[[3]],
                          rownames(counts.frame),
                          ann.mapping)
GO.over.pop.all <- over.goseq(contigs.l[[3]],
                              rownames(counts.frame),
                              all.ann.mapping)
...
GO.over.sex.eel <- over.goseq(contigs.l[[4]],
                              rownames(counts.frame),
                              ann.mapping)
GO.over.sex.eel.all <- over.goseq(contigs.l[[4]],
                                  rownames(counts.frame),
                                  all.ann.mapping)
...
GO.over.sex.pop <- over.goseq(contigs.l[[5]],
                              rownames(counts.frame),
                              ann.mapping)
GO.over.sex.pop.all <- over.goseq(contigs.l[[5]],
                                  rownames(counts.frame),
                                  all.ann.mapping)
...
GO.over.eel.pop <- over.goseq(contigs.l[[6]],
                              rownames(counts.frame),
                              ann.mapping)
GO.over.eel.pop.all <- over.goseq(contigs.l[[6]],
                                  rownames(counts.frame),
                                  all.ann.mapping)
...
GO.over.sex.eel.pop.all <- over.goseq(contigs.l[[7]],
                                      rownames(counts.frame),
                                      all.ann.mapping)
