...
##### Male
m.c <- counts.frame[ , sex.conds=="male" ]
...
topTags.male <- tt[tt.male$table$adj.P.Val<0.05]

#### Female
f.c <- counts.frame[ , sex.conds=="female" ]
## Counts frame to full DGEList
df <- DGEList(f.c,
...
topTags.female <- tt[tt.female$table$adj.P.Val<0.05]
