...
pdf("/home/ele/thesis/experimental_infection/figures/edgeR_venns.pdf", width=20, height=20)

vp1 <- viewport(x=0.01, y=0.5, w=0.48, h=0.51,
                just=c("left", "bottom"))
vp2 <- viewport(x=0.01, y=0, w=0.48, h=0.49,
                just=c("left", "bottom"))
...
grid.text(Not.sex, x=unit(0.07,"npc"), y=unit(0.1,"npc"), gp=gpar(fontfamily="serif"))
grid.draw(sex.venn)
popViewport()
